...
void CSlowDataEncoder::setHeaderData(const CHeaderData& header)
{
	...
	m_headerData[4U]  = header.getRptCall2().at(0);
	m_headerData[5U]  = header.getRptCall2().at(1);

	m_headerData[6U]  = SLOW_DATA_TYPE_HEADER | 5U;
	m_headerData[7U]  = header.getRptCall2().at(2);
	m_headerData[8U]  = header.getRptCall2().at(3);
	m_headerData[9U]  = header.getRptCall2().at(4);
	m_headerData[10U] = header.getRptCall2().at(5);
	m_headerData[11U] = header.getRptCall2().at(6);

	m_headerData[12U] = SLOW_DATA_TYPE_HEADER | 5U;
	m_headerData[13U] = header.getRptCall2().at(7);
	m_headerData[14U] = header.getRptCall1().at(0);
	m_headerData[15U] = header.getRptCall1().at(1);
	m_headerData[16U] = header.getRptCall1().at(2);
	m_headerData[17U] = header.getRptCall1().at(3);

	m_headerData[18U] = SLOW_DATA_TYPE_HEADER | 5U;
	m_headerData[19U] = header.getRptCall1().at(4);
	m_headerData[20U] = header.getRptCall1().at(5);
	m_headerData[21U] = header.getRptCall1().at(6);
	m_headerData[22U] = header.getRptCall1().at(7);
	m_headerData[23U] = header.getYourCall().at(0);

	m_headerData[24U] = SLOW_DATA_TYPE_HEADER | 5U;
	m_headerData[25U] = header.getYourCall().at(1);
	m_headerData[26U] = header.getYourCall().at(2);
	m_headerData[27U] = header.getYourCall().at(3);
	m_headerData[28U] = header.getYourCall().at(4);
	m_headerData[29U] = header.getYourCall().at(5);

	m_headerData[30U] = SLOW_DATA_TYPE_HEADER | 5U;
	m_headerData[31U] = header.getYourCall().at(6);
	m_headerData[32U] = header.getYourCall().at(7);
	m_headerData[33U] = header.getMyCall1().at(0);
	m_headerData[34U] = header.getMyCall1().at(1);
	m_headerData[35U] = header.getMyCall1().at(2);

	m_headerData[36U] = SLOW_DATA_TYPE_HEADER | 5U;
	m_headerData[37U] = header.getMyCall1().at(3);
	m_headerData[38U] = header.getMyCall1().at(4);
	m_headerData[39U] = header.getMyCall1().at(5);
	m_headerData[40U] = header.getMyCall1().at(6);
	m_headerData[41U] = header.getMyCall1().at(7);

	m_headerData[42U] = SLOW_DATA_TYPE_HEADER | 5U;
	m_headerData[43U] = header.getMyCall2().at(0);
	m_headerData[44U] = header.getMyCall2().at(1);
	m_headerData[45U] = header.getMyCall2().at(2);
	m_headerData[46U] = header.getMyCall2().at(3);
...
void CSlowDataEncoder::setTextData(const std::string& text)
{
	...
	paddedText.resize(20, ' ');

	m_textData[0U]  = SLOW_DATA_TYPE_TEXT | 0U;
	m_textData[1U]  = paddedText.at(0);
	m_textData[2U]  = paddedText.at(1);
	m_textData[3U]  = paddedText.at(2);
	m_textData[4U]  = paddedText.at(3);
	m_textData[5U]  = paddedText.at(4);

	m_textData[6U]  = SLOW_DATA_TYPE_TEXT | 1U;
	m_textData[7U]  = paddedText.at(5);
	m_textData[8U]  = paddedText.at(6);
	m_textData[9U]  = paddedText.at(7);
	m_textData[10U] = paddedText.at(8);
	m_textData[11U] = paddedText.at(9);

	m_textData[12U] = SLOW_DATA_TYPE_TEXT | 2U;
	m_textData[13U] = paddedText.at(10);
	m_textData[14U] = paddedText.at(11);
	m_textData[15U] = paddedText.at(12);
	m_textData[16U] = paddedText.at(13);
	m_textData[17U] = paddedText.at(14);

	m_textData[18U] = SLOW_DATA_TYPE_TEXT | 3U;
	m_textData[19U] = paddedText.at(15);
	m_textData[20U] = paddedText.at(16);
	m_textData[21U] = paddedText.at(17);
	m_textData[22U] = paddedText.at(18);
	m_textData[23U] = paddedText.at(19);

	m_textPtr = 0U;
}

void CSlowDataEncoder::setGPSData(const std::string& gpsData)
{
	...
	if((gpsDataStrLen = gpsData.size()) > 0){
		...
		for(gpsDataPos = 0; gpsDataPos < m_gpsDataFullSize;){
			...
			for(unsigned int i = 0U; i < dataLen; i++){
				m_gpsData[gpsDataPos++] = gpsData.at(strPos++);
			}
		}
	}
}
